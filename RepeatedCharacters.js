function showMostRepeatedChar(str) {
    ...
    str.split(" ").join("").split("").forEach(function (char) {  //splits up the argument's string by letters and performs local function to do with them individually as a argument
